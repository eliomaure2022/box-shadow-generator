...
hShadowRange.addEventListener("input", (e) => {
  ...
  square.style.boxShadow = `${e.target.value}px ${vShadowValue}px ${blurValue}px ${spreadValue}px  ${shadowColorValue}`;
});

vShadowRange.addEventListener("input", (e) => {
  vShadow.innerHTML = `${e.target.value}px`;
  vShadowValue = e.target.value;
  square.style.boxShadow = `${hShadowValue}px ${e.target.value}px ${blurValue}px  ${spreadValue}px ${shadowColorValue}`;
});

blurRange.addEventListener("input", (e) => {
  blurS.innerHTML = `${e.target.value}px`;
  blurValue = e.target.value;
  square.style.boxShadow = `${hShadowValue}px ${vShadowValue}px ${e.target.value}px  ${spreadValue}px ${shadowColorValue}`;
});

spreadRange.addEventListener("input", (e) => {
  spread.innerHTML = `${e.target.value}px`;
  spreadValue = e.target.value;
  square.style.boxShadow = `${hShadowValue}px ${vShadowValue}px ${blurValue}px ${e.target.value}px  ${shadowColorValue}`;
});

shadowColor.addEventListener("input", (e) => {
  shadowColorValue = e.target.value;
  square.style.boxShadow = `${hShadowValue}px ${vShadowValue}px ${blurValue}px ${spreadValue}px ${e.target.value}px `;
});
